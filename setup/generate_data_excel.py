...
with open("2025/workspace/data.json", "r") as f:
...
def add_dates(start_col=8, start_date="12/04/2024", end_date="20/10/2024"):
...
xl.writexl(db=db, fn="2025/workspace/data.xlsx")
