...
with open("2026/workspace/data.json", "r") as f:
...
def add_dates(start_col=8, start_date="18/04/2026", end_date="20/10/2026"):
...
xl.writexl(db=db, fn="2026/workspace/data.xlsx")
